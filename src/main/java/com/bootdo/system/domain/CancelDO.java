 ...
 */
public class CancelDO implements Serializable {
	 ...
	 * 设置：
	 */
	public void setQueCancel(String queCancel) {
		this.queCancel = queCancel;
	}
	/**
	 * 获取：
	 */
	public String getQueCancel() {
		return queCancel;
	}
}
